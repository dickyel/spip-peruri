                  ...
                  <div class="card">
                      <div class="card-body">
                          <div class="profile-data py-3 px-1">
                            <form action="{{ route('methodology.update', $method->id) }}" method="post" enctype="multipart/form-data">
                              @method('put')
                              @csrf
                            ...
                            <span>
                              <a href="{{ route('methodology.delete', $method->id) }}" class="btn btn-danger">Hapus</a>
                            </span>
                          </div>
                      </div>
                ...
                @empty
                  <div class="col-md-6 align-items-center">
                    <div class="card">
                      <div class="card-body">
                        <div class="profile-data py-3 px-1">
                              <form action="{{ route('methodology.store') }}" method="post" enctype="multipart/form-data">
